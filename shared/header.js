const pageTitles = {
  ...
  'inv-list': '库存查询', 'inv-entry': '入库记录', 'inv-inquiry': '入库查询', 'inv-transfer': '调拨记录',
  'inv-return': '退货记录', 'inv-check': '盘点记录', 'inv-detail': '库存明细',
  'supply-price': '采购定价', 'price-approval': '价格审批',
  ...
  'marketing-price-rule': '动态调价初始需求', 'dynamic-pricing': '动态调价·体验版', 'dynamic-pricing-full': '动态调价·完整版'
};
...
const NO_SCOPE_PAGES = [
  ...
  'product-memo', 'item-code', 'marketing-price-rule', 'dynamic-pricing', 'dynamic-pricing-full',
  'inventory-notify', 'scenario',
  'inv-list', 'inv-entry', 'inv-inquiry', 'inv-transfer', 'inv-return', 'inv-check', 'inv-detail',
  'supply-price', 'price-approval',
...
const PAGE_GROUPS = {
  ...
  member: '客户运营', inventory: '库存管理', 'inventory-notify': '库存管理',
  ...
  'marketing-price-rule': '营销管理', 'dynamic-pricing': '营销管理', 'dynamic-pricing-full': '营销管理',
  'inv-list': '库存管理', 'inv-entry': '库存管理', 'inv-inquiry': '库存管理', 'inv-transfer': '库存管理',
  'inv-return': '库存管理', 'inv-check': '库存管理', 'inv-detail': '库存管理',
  'supply-price': '库存管理', 'price-approval': '库存管理',
