...
var GD_CATS = [
  ...
  { l1: '生鲜', l2: '蔬菜', l3: '叶菜', l4: '娃娃菜' },
  { l1: '生鲜', l2: '蔬菜', l3: '叶菜', l4: '上海青' },
  { l1: '生鲜', l2: '蔬菜', l3: '叶菜', l4: '青麻叶白菜' },
  { l1: '生鲜', l2: '蔬菜', l3: '叶菜', l4: '崇明白菜' },
  { l1: '生鲜', l2: '蔬菜', l3: '叶菜', l4: '胶东白菜' },
  { l1: '生鲜', l2: '蔬菜', l3: '叶菜', l4: '洛阳白菜' },
  { l1: '生鲜', l2: '蔬菜', l3: '根茎', l4: '土豆' },
  { l1: '生鲜', l2: '蔬菜', l3: '根茎', l4: '白萝卜' },
  { l1: '生鲜', l2: '蔬菜', l3: '茄果', l4: '西红柿' },
  { l1: '生鲜', l2: '水果', l3: '热带水果', l4: '榴莲' },
  { l1: '生鲜', l2: '水果', l3: '柑橘', l4: '橙子' },
  { l1: '生鲜', l2: '水果', l3: '仁果', l4: '红富士苹果' },
  { l1: '生鲜', l2: '肉禽蛋', l3: '猪肉', l4: '五花肉' },
  { l1: '生鲜', l2: '肉禽蛋', l3: '蛋品', l4: '鸡蛋' },
  { l1: '生鲜', l2: '肉禽蛋', l3: '禽类', l4: '三黄鸡' },
  { l1: '生鲜', l2: '水产', l3: '淡水鱼', l4: '鲈鱼' },
  { l1: '生鲜', l2: '水产', l3: '淡水鱼', l4: '草鱼' },
  { l1: '食品', l2: '粮油调味', l3: '大米', l4: '东北大米' },
  { l1: '食品', l2: '粮油调味', l3: '食用油', l4: '花生油' },
  { l1: '食品', l2: '粮油调味', l3: '食用油', l4: '调和油' },
  { l1: '食品', l2: '休闲食品', l3: '饼干', l4: '苏打饼干' },
  { l1: '食品', l2: '方便食品', l3: '方便面', l4: '红烧牛肉面' },
  { l1: '食品', l2: '方便食品', l3: '速冻食品', l4: '水饺' },
...
var STD_SEED = [
  ...
  // —— STD021~032：覆盖门店在售商品（INV_GOODS g-01~g-12），barcode 与门店商品编码一致，用作品名关联键 ——
  // 系统品名是规范名（不带品牌、用学名），门店销售品名可带品牌与俗称，两者不同属正常
  { stdId: 'STD021', barcode: '6901234500017', name: '娃娃菜', brand: '青蔬', unit: '公斤', spec: '500g/份', l1: '生鲜', l2: '蔬菜', l3: '叶菜', l4: '娃娃菜', shelfLife: 5, shelfUnit: '天', storage: '冷藏', image: '', status: '0', operator: '系统补录', related: [] },
  { stdId: 'STD022', barcode: '6901234500024', name: '上海青', brand: '青蔬', unit: '公斤', spec: '400g/份', l1: '生鲜', l2: '蔬菜', l3: '叶菜', l4: '上海青', shelfLife: 4, shelfUnit: '天', storage: '冷藏', image: '', status: '0', operator: '系统补录', related: [] },
  { stdId: 'STD023', barcode: '6901234500031', name: '白萝卜', brand: '青蔬', unit: '公斤', spec: '称重', l1: '生鲜', l2: '蔬菜', l3: '根茎', l4: '白萝卜', shelfLife: 10, shelfUnit: '天', storage: '冷藏', image: '', status: '0', operator: '系统补录', related: [] },
  { stdId: 'STD024', barcode: '6901234500048', name: '马铃薯', brand: '崧泽', unit: '公斤', spec: '称重', l1: '生鲜', l2: '蔬菜', l3: '根茎', l4: '土豆', shelfLife: 30, shelfUnit: '天', storage: '常温', image: '', status: '0', operator: '系统补录', related: [] },
  { stdId: 'STD025', barcode: '6901234500055', name: '番茄', brand: '青蔬', unit: '公斤', spec: '称重', l1: '生鲜', l2: '蔬菜', l3: '茄果', l4: '西红柿', shelfLife: 6, shelfUnit: '天', storage: '冷藏', image: '', status: '0', operator: '系统补录', related: [] },
  { stdId: 'STD026', barcode: '6901234500062', name: '带皮五花肉', brand: '正大', unit: '公斤', spec: '称重', l1: '生鲜', l2: '肉禽蛋', l3: '猪肉', l4: '五花肉', shelfLife: 3, shelfUnit: '天', storage: '冷藏', image: '', status: '0', operator: '系统补录', related: [] },
  { stdId: 'STD027', barcode: '6901234500079', name: '鲜鸡蛋', brand: '德青源', unit: '盒', spec: '30枚/盒', l1: '生鲜', l2: '肉禽蛋', l3: '蛋品', l4: '鸡蛋', shelfLife: 45, shelfUnit: '天', storage: '冷藏', image: '', status: '0', operator: '系统补录', related: [] },
  { stdId: 'STD028', barcode: '6901234500086', name: '草鱼', brand: '淀山湖', unit: '公斤', spec: '称重', l1: '生鲜', l2: '水产', l3: '淡水鱼', l4: '草鱼', shelfLife: 2, shelfUnit: '天', storage: '冷藏', image: '', status: '0', operator: '系统补录', related: [] },
  { stdId: 'STD029', barcode: '6901234500093', name: '苹果(红富士)', brand: '栖霞', unit: '公斤', spec: '称重', l1: '生鲜', l2: '水果', l3: '仁果', l4: '红富士苹果', shelfLife: 15, shelfUnit: '天', storage: '冷藏', image: '', status: '0', operator: '系统补录', related: [] },
  { stdId: 'STD030', barcode: '6901234500109', name: '食用调和油', brand: '金龙鱼', unit: '瓶', spec: '5L/瓶', l1: '食品', l2: '粮油调味', l3: '食用油', l4: '调和油', shelfLife: 540, shelfUnit: '天', storage: '常温', image: '', status: '0', operator: '系统补录', related: [] },
  { stdId: 'STD031', barcode: '6901234500116', name: '鲜牛奶', brand: '光明', unit: '盒', spec: '950ml/盒', l1: '乳品', l2: '乳制品', l3: '牛奶', l4: '鲜牛奶', shelfLife: 7, shelfUnit: '天', storage: '冷藏', image: '', status: '0', operator: '系统补录', related: [] },
  { stdId: 'STD032', barcode: '6901234500123', name: '速冻水饺', brand: '思念', unit: '袋', spec: '1kg/袋', l1: '食品', l2: '方便食品', l3: '速冻食品', l4: '水饺', shelfLife: 180, shelfUnit: '天', storage: '冷冻', image: '', status: '0', operator: '系统补录', related: [] }
];
function gdStdLoad() {
  try { var r = localStorage.getItem(GD_STD_KEY); if (r) { GD_STD = JSON.parse(r); gdStdSeedMerge(); return; } } catch (e) {}
  GD_STD = JSON.parse(JSON.stringify(STD_SEED)); gdStdPersist();
}
// 补种：老 localStorage 里没有后补的 STD021~032（覆盖门店在售商品），按 stdId 补齐一次。
// 标记位保证只补一次——否则用户在标准商品页删掉一条后刷新又会自己长回来。
function gdStdSeedMerge() {
  try { if (localStorage.getItem('tcm_goods_std_seed_v2')) return; } catch (e) { return; }
  try {
    var have = {}; GD_STD.forEach(function (s) { have[s.stdId] = 1; });
    var add = STD_SEED.filter(function (s) { return !have[s.stdId]; });
    if (add.length) { GD_STD = GD_STD.concat(JSON.parse(JSON.stringify(add))); gdStdPersist(); }
    localStorage.setItem('tcm_goods_std_seed_v2', '1');
  } catch (e) {}
}
// 门店商品 → 标准商品：按编码关联（INV_GOODS.code ↔ GD_STD.barcode）。
// 老数据的商品没有 stdId，首次访问时回填并持久化；关联不上返回 null（该商品未纳入标准库）。
function gdStdOfGoods(g) {
  if (!g) return null;
  if (g.stdId) return gdStdById(g.stdId);
  if (typeof GD_STD === 'undefined' || !GD_STD.length || !g.code) return null;
  for (var i = 0; i < GD_STD.length; i++) {
    if (GD_STD[i].barcode && GD_STD[i].barcode === g.code) {
      g.stdId = GD_STD[i].stdId;
      if (typeof invListPersist === 'function') { try { invListPersist(); } catch (e) {} }
      return GD_STD[i];
    }
  }
  return null;
...
function gdStdRender(page) {
  ...
  }).join('') || '<tr><td colspan="13" style="text-align:center;color:#909399;padding:40px">暂无数据</td></tr>';
