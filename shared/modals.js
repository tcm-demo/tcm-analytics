...
<div class="mobile-more-menu" id="mobileMoreMenu">
  ...
  <div class="mobile-more-item" onclick="mobileMoreSelect('inv-list')">
    <span class="mm-icon">🗃️</span> 库存查询
  </div>
  <div class="mobile-more-item" onclick="mobileMoreSelect('inv-entry')">
    <span class="mm-icon">📥</span> 入库记录
  </div>
  <div class="mobile-more-item" onclick="mobileMoreSelect('inv-inquiry')">
    <span class="mm-icon">🧾</span> 入库查询
  </div>
  ...
  <div class="mobile-more-item" onclick="mobileMoreSelect('inv-check')">
    ...
    <span class="mm-phase-tag tag-opt">优化</span>
  </div>
  <div class="mobile-more-item" onclick="mobileMoreSelect('inv-detail')">
    <span class="mm-icon">📋</span> 库存明细
  </div>
  ...
  <div class="mobile-more-item" onclick="mobileMoreSelect('dynamic-pricing')">
    <span class="mm-icon">🎯</span> 动态调价·体验版
  </div>
  <div class="mobile-more-item" onclick="mobileMoreSelect('dynamic-pricing-full')">
    <span class="mm-icon">🎯</span> 动态调价·完整版
  </div>
